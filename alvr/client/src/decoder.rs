...
pub static CODEC: Lazy<Mutex<CodecType>> = Lazy::new(|| Mutex::new(CodecType::H264));
pub static REALTIME_DECODER: Lazy<Mutex<bool>> = Lazy::new(|| Mutex::new(false));
